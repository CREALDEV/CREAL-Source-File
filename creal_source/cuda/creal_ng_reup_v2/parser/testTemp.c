...
#include <omp.h>
 ...
 uint numOfRange; 
 uint count; //the counting variable 
...
struct pre_actionlist crealActions[1000];
 ...
 void creal_init(); /* this is the main initiation function for creal */ 
...
creal_t conditionFunction_47_3(void);
...
crealActions[47].conditions[3].conditionFunction = &conditionFunction_47_3;
