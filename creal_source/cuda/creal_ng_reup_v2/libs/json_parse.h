...
int fuseCreaNodesToPropertiesAndActions(creal_t propertiesArray[], json_t **root, int numOfCrealNodes); //this is used to fuse the properties and actions to the creal nodes
...
int fuseCreaNodesToPropertiesAndActions(creal_t propertiesArray[], json_t **root, int numOfCrealNodes)
{
